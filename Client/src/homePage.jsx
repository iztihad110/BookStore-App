                  ...
                  bookData.map((item)=>{
                     return <div className="mb-1 row single-book">
                        <div className="col-md-5 book-title ">
                           ...
                           <div className="edit-book-button col-md-3">
                              <svg xmlns="http://www.w3.org/2000/svg" onClick={()=>handleClick(`/edit-book/${item._id}`)} class="ionicon" viewBox="0 0 512 512"><path d="M384 224v184a40 40 0 01-40 40H104a40 40 0 01-40-40V168a40 40 0 0140-40h167.48" fill="none"
